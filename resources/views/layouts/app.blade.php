        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex space-x-6 text-sm font-medium">
                    ...
                    <!-- Tra cứu: Không có filter hoặc filter=all -->
                    ...
                    <a href="{{ route('topic-registrations.index') }}" class="{{ request()->routeIs('topic-registrations.*') ? 'text-blue-600 font-bold border-b-2 border-blue-600 pb-1' : 'text-gray-600 hover:text-blue-600' }} transition">Đồ án của tôi</a>
                    @endif
                    @endif
                </div>
